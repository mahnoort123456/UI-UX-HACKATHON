          ...
          <div className="flex items-center justify-between bg-white p-4 rounded-lg shadow-md mb-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className=" text-black flex gap-3 mt-3">
                  <CiHeart />
                  <RiDeleteBin6Line />
                </div>
              </div>
          ...
          <div className="flex items-center justify-between bg-white p-4 rounded-lg shadow-md">
            <div className="flex items-center space-x-4">
              <div className="w-24 h-24 bg-gray-300 rounded">
                <Image src={require('@/public/image/Frame (1).png')} alt="." width={150} height={150} />
              </div>
              <div>
                <h3 className="text-[16px]  font-normal text-[#272343] mb-3">
                  Library Stool Chair
        ...
        <div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex justify-between mb-4">
              ...
              <p className="text-lg  text-black font-semibold">$198.00</p>
            </div>
            <div className="flex justify-between mb-4">
            ...
            <div className="flex justify-between mb-6">
              ...
              <p className="text-xl text-black font-bold">$198.00</p>
            </div>
